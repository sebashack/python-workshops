...
def gen_vehicle_day_samples_flattened(
    num_days, max_vehicle_sz, max_stops, center, rad, data
):
    ...
    for i in range(num_days):
        s = gen_vehicle_day_sample(max_vehicle_sz, max_stops, i, coord_gen, data)
...
# The data structure generated by this function is `[[VehicleDay]]`
def gen_vehicle_day_samples(num_days, max_vehicle_sz, max_stops, center, rad, data):
    check_num_days_max_stops(num_days, max_stops)
...
def gen_day_samples_as_dict(num_days, max_vehicle_sz, max_stops, center, rad, data):
    check_num_days_max_stops(num_days, max_stops)
...
def gen_vehicle_day_sample(max_vehicle_size, max_stops, day_idx, coord_gen, data):
    vehicles = data.vehicles
